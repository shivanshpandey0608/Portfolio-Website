  ...
  const handleSendMessage = () => {
    ...
    setTimeout(() => {
      ...
      if (userInput.includes("services")) {
        reply = "Shivansh Pandey offers services in frontend, backend development, animations, and AI integration. Would you like a portfolio link?";
      } else if (userInput.includes("contact")) {
        reply = "You can contact Shivansh Pandey via the contact form above or email him directly at pandeyarpit28212@gmail.com";
      } else if (userInput.includes("react") || userInput.includes("gsap")) {
        reply = "Yes! Shivansh Pandey uses React, GSAP, and even WebGL to build stunning UIs.";
