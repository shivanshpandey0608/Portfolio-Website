...
const skills = [
  ...
  { icon: Code, name: 'CSS3', level: 90 },
  { icon: Code, name: 'JavaScript', level: 95 },
  { icon: Lightning, name: 'Tailwind CSS', level: 91 },
  { icon: Cube, name: 'Node.js', level: 91 },
  { icon: Rocket, name: 'React.js', level: 85 },
  { icon: Heart, name: 'Express.js', level: 87 },
  { icon: Database, name: 'MongoDB / Mongoose', level: 87 },
  { icon: Database, name: 'SQL (PostgreSQL / MySQL)', level: 87 },
  { icon: GitBranch, name: 'Git', level: 87 },
  { icon: GitBranch, name: 'GitHub', level: 89 },
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div ref={contentRef} className="space-y-6">
            ...
            <p className="text-lg text-muted-foreground leading-relaxed">
              I am a Full-Stack Developer with hands-on project experience in building responsive and scalable web applications using React.js, Node.js, Express, MongoDB, and SQL databases (PostgreSQL/MySQL). I have experience developing RESTful APIs, integrating frontend and backend components, and following best practices for secure and efficient application design.
            </p>

            <p className="text-lg text-muted-foreground leading-relaxed">
              I am comfortable working across both frontend and backend development, with a strong focus on clean, readable code, responsive UI design, and delivering smooth user experiences, including animation-driven interfaces using Framer Motion. I also have exposure to version control with Git and containerized deployment workflows using Docker.
            </p>

            <div className="flex flex-wrap gap-4 pt-4">
              <div className="glass px-4 py-2 rounded-lg">
                <span className="text-primary-glow font-medium"></span>
                <span className="text-muted-foreground ml-1">Fresher</span>
              </div>
              <div className="glass px-4 py-2 rounded-lg">
